...
export default function DashboardSidebar({ profile, email }: DashboardSidebarProps) {
  ...
  function isNavItemActive(href: string, exact?: boolean) {
    // RSVP Tracker is active on /dashboard/rsvp and /dashboard/invitations/[id]/rsvp
    ...
    // My Invitations is active on /dashboard/invitations routes EXCEPT invitation-specific RSVP routes
