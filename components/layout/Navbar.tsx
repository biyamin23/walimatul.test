 ...
 * Brand: WALIMATUL (large) / by nasuhalias (small, gold)
 */
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link
              ...
              className="inline-flex items-center gap-1.5 px-5 py-2.5 text-sm font-semibold text-white bg-[var(--primary)] hover:bg-[var(--primary-hover)] rounded-[var(--radius-lg)] transition-colors focus-visible:outline-2 focus-visible:outline-[var(--primary)] focus-visible:outline-offset-2"
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <div className="flex flex-col gap-2 px-4">
              ...
              <Link
                href={SITE_NAV.templates}
                className="w-full text-center py-3.5 px-6 text-sm font-semibold text-white bg-[var(--primary)] hover:bg-[var(--primary-hover)] rounded-[var(--radius-lg)] transition-colors focus-visible:outline-2 focus-visible:outline-[var(--primary)] focus-visible:outline-offset-2"
                onClick={() => setIsMenuOpen(false)}
              >
                Create Invitation
              </Link>
