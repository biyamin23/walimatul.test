...
interface KpiCardProps {
  ...
  accentBg: string;     // CSS color for icon background
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="text-[11px] font-ui font-medium uppercase tracking-wider mt-0.5"
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-1 text-xs sm:text-sm font-ui"
          style={{ color: "var(--text-muted)" }}>
      ...
      <section aria-labelledby="kpi-heading">
        <h2 id="kpi-heading" className="sr-only">Metrik Platform</h2>
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          ...
          <KpiCard
            ...
            subtext="Daripada orders.amount"
            icon={
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      ...
      <section aria-labelledby="quick-nav-heading">
        <h2 id="quick-nav-heading" className="font-display text-lg font-semibold mb-4"
          style={{ color: "var(--text)" }}>
          Navigasi Pantas
        </h2>
