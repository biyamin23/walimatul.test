...
export default function DashboardInvitationsLoading() {
  return (
    <div className="space-y-6 sm:space-y-8 animate-pulse" aria-busy="true" aria-label="Memuatkan senarai jemputan...">
      {/* Header Skeleton */}
