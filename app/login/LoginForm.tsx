          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label
                ...
                className="block text-sm font-medium text-[var(--text)] font-ui"
              >
                Password
              </label>
              <Link
                href="/forgot-password"
                className="text-xs text-[var(--primary)] hover:underline font-ui focus-visible:outline-2 focus-visible:outline-[var(--primary)] focus-visible:outline-offset-2 rounded"
              >
                Forgot password?
              </Link>
            </div>
