...
export function EventDetailsSection({ data, mode = "live" }: EventDetailsSectionProps) {
    ...
    <ChateauSection ariaLabel="Aturcara Majlis dan Lokasi">
      <ChateauReveal variant="fade-up" duration={750} disabled={isEditor} className="w-full">
        <ChateauCard hasGlow>
          ...
          {parsedDate && (
            <div className="mb-6">
              <ChateauReveal variant="scale" delay={180} duration={750} disabled={isEditor}>
              ...
              {timeDisplay && (
                <ChateauReveal variant="fade-up" delay={260} duration={650} disabled={isEditor}>
          ...
          {parsedDate && hasVenue && <ChateauFloralDivider className="my-6 opacity-60" animated={!isEditor} />}

          {/* Venue Information */}
          {hasVenue && (
            <ChateauReveal variant="fade-up" delay={320} duration={750} disabled={isEditor}>
              <div className="mb-4">
          ...
          {/* Maps & Waze Actions */}
          {(hasMaps || hasWaze) && (
            <ChateauReveal variant="fade-up" delay={400} duration={750} disabled={isEditor}>
