  ...
  return (
    <ChateauSection ariaLabel="Pengesahan Kehadiran">
      <ChateauReveal variant="fade-up" duration={700} disabled={isEditor}>
        <ChateauCard hasGlow>
          {/* Eyebrow */}
          <ChateauReveal variant="fade" delay={100} duration={600} disabled={isEditor}>
          ...
          {/* Heading */}
          <ChateauReveal variant="fade-up" delay={200} duration={650} disabled={isEditor}>
          ...
          {/* Description */}
          <ChateauReveal variant="fade-up" delay={300} duration={650} disabled={isEditor}>
          ...
          {/* Deadline */}
          {deadlineFormatted && (
            <ChateauReveal variant="scale" delay={380} duration={600} disabled={isEditor}>
          ...
          {/* Pax & notes info */}
          <ChateauReveal variant="fade" delay={460} duration={600} disabled={isEditor}>
          ...
          {/* Action Button: Sahkan Kehadiran (with subtle entrance emphasis) */}
          <ChateauReveal variant="scale" delay={550} duration={700} disabled={isEditor}>
            <button
              type="button"
              onClick={() => {
                if (mode === "preview") {
              ...
              className={`w-full sm:w-auto min-w-[220px] px-8 py-3.5 rounded-full font-chateau-body text-xs sm:text-sm font-semibold tracking-wider uppercase transition-all duration-300 shadow-md flex items-center justify-center gap-2 mx-auto focus-visible:outline-2 focus-visible:outline-[#6B2333] focus-visible:outline-offset-2 ${
                isDeadlinePassed
                  ...
                  : "bg-[#6B2333] text-white hover:bg-[#521A26] border border-[#B58A4A]/40 hover:shadow-lg active:scale-95 cursor-pointer hover:border-[#B58A4A]"
              }`}
            >
